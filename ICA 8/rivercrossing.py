...
# Initilize pygame, mixer, display and clock
...
# Load all images
man_img = pygame.image.load("resources/graphics/man.png")
fox_img = pygame.image.load("resources/graphics/fox.png")
chicken_img = pygame.image.load("resources/graphics/chicken.png")
grain_img = pygame.image.load("resources/graphics/grain.png")
gameover_img = pygame.image.load("resources/graphics/gameover.png")
youwon_img = pygame.image.load("resources/graphics/youwon.png")
wave1 = pygame.image.load("resources/graphics/wave1.png")
log = pygame.image.load("resources/graphics/log.png")
background_img = pygame.image.load("resources/graphics/background.png")
playagain_img = pygame.image.load("resources/graphics/playagain.png")
rock = pygame.image.load("resources/graphics/rock.png")
rock2 = pygame.image.load("resources/graphics/rock2.png")
pause = pygame.image.load("resources/graphics/pause.png")
controls = pygame.image.load("resources/graphics/controls.png")
frontsea = pygame.image.load("resources/graphics/frontsea.png")
pausebackground = pygame.image.load("resources/graphics/pausebackground.png")
gameoverbackground = pygame.image.load("resources/graphics/gameoverbackground.png")
startscreen = pygame.image.load("resources/graphics/startscreen.png")
...
def gameloop():
	...
	# Where to place passenger in boat
